 ...
 */
final class Version20220303142342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE params ADD subtitleparam VARCHAR(255) DEFAULT NULL');
    }
