 ...
 */
final class Version20220311175108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE params ADD assosparam LONGTEXT DEFAULT NULL, ADD masterparam LONGTEXT DEFAULT NULL');
    }
