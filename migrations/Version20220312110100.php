 ...
 */
final class Version20220312110100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE internships (id INT AUTO_INCREMENT NOT NULL, titleinternship VARCHAR(255) NOT NULL, offerinternship LONGTEXT DEFAULT NULL, placeintership VARCHAR(255) DEFAULT NULL, startinternship DATE DEFAULT NULL, endinternship DATE DEFAULT NULL, linkinternship VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
