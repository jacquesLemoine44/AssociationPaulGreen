 ...
 */
final class Version20220313112124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fieldtripphotos (id INT AUTO_INCREMENT NOT NULL, fieldstripsorigin_id INT DEFAULT NULL, filefieldtripphoto VARCHAR(255) NOT NULL, altfieldtripphoto VARCHAR(255) DEFAULT NULL, INDEX IDX_F09AAB91C1C7BE9B (fieldstripsorigin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fieldtrips (id INT AUTO_INCREMENT NOT NULL, usersorigin_id INT DEFAULT NULL, datefieldtrip DATE DEFAULT NULL, titlefieldtrip VARCHAR(255) NOT NULL, picturefieldtrip VARCHAR(255) DEFAULT NULL, textfieldtrip LONGTEXT DEFAULT NULL, INDEX IDX_E49A697B3231D76 (usersorigin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE fieldtripphotos ADD CONSTRAINT FK_F09AAB91C1C7BE9B FOREIGN KEY (fieldstripsorigin_id) REFERENCES fieldtrips (id)');
        $this->addSql('ALTER TABLE fieldtrips ADD CONSTRAINT FK_E49A697B3231D76 FOREIGN KEY (usersorigin_id) REFERENCES users (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE fieldtripphotos DROP FOREIGN KEY FK_F09AAB91C1C7BE9B');
        $this->addSql('DROP TABLE fieldtripphotos');
        $this->addSql('DROP TABLE fieldtrips');
