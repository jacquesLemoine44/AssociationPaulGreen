 ...
 */
final class Version20220313121552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fieldtrips ADD altpicturefieldtrip VARCHAR(255) DEFAULT NULL');
    }
