 ...
 */
final class Version20220315100438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE affectations (id INT AUTO_INCREMENT NOT NULL, nameaffectation VARCHAR(100) NOT NULL, descriptionaffectation VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipments (id INT AUTO_INCREMENT NOT NULL, equipementsstorages_id INT DEFAULT NULL, equipmentsaffectations_id INT DEFAULT NULL, equipmentsusers_id INT DEFAULT NULL, nameequipement VARCHAR(255) NOT NULL, quantityequipment DOUBLE PRECISION DEFAULT NULL, quantityminiequipment DOUBLE PRECISION DEFAULT NULL, daterebusequipment DATE DEFAULT NULL, loanequipment DATE DEFAULT NULL, borrowerequipment VARCHAR(255) DEFAULT NULL, INDEX IDX_6F6C25445A0A5C2C (equipementsstorages_id), INDEX IDX_6F6C2544F5B36E0C (equipmentsaffectations_id), INDEX IDX_6F6C254433B541AC (equipmentsusers_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE storages (id INT AUTO_INCREMENT NOT NULL, namestorage VARCHAR(100) NOT NULL, descriptionstorage VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE equipments ADD CONSTRAINT FK_6F6C25445A0A5C2C FOREIGN KEY (equipementsstorages_id) REFERENCES storages (id)');
        $this->addSql('ALTER TABLE equipments ADD CONSTRAINT FK_6F6C2544F5B36E0C FOREIGN KEY (equipmentsaffectations_id) REFERENCES affectations (id)');
        $this->addSql('ALTER TABLE equipments ADD CONSTRAINT FK_6F6C254433B541AC FOREIGN KEY (equipmentsusers_id) REFERENCES users (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE equipments DROP FOREIGN KEY FK_6F6C2544F5B36E0C');
        $this->addSql('ALTER TABLE equipments DROP FOREIGN KEY FK_6F6C25445A0A5C2C');
