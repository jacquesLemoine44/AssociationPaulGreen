 ...
 */
final class Version20220316091426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users_functions (users_id INT NOT NULL, functions_id INT NOT NULL, INDEX IDX_25D157ED67B3B43D (users_id), INDEX IDX_25D157ED9011893B (functions_id), PRIMARY KEY(users_id, functions_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
