 ...
 */
final class Version20220316093154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE functions ADD level_function INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE functions_users (functions_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_A549F79F9011893B (functions_id), INDEX IDX_A549F79F67B3B43D (users_id), PRIMARY KEY(functions_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE functions DROP level_function, CHANGE mission mission VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description_function description_function LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
