 ...
 */
final class Version20220318171145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actions_masters ADD actions_users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE actions_masters ADD CONSTRAINT FK_B3C951E5B814011E FOREIGN KEY (actions_users_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_B3C951E5B814011E ON actions_masters (actions_users_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos_actions_masters CHANGE photoactionsmaster photoactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE altphotoactionsmaster altphotoactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
