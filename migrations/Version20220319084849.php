 ...
 */
final class Version20220319084849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actions_masters ADD linkactionsmaster VARCHAR(255) DEFAULT NULL');
    }
