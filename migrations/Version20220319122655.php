 ...
 */
final class Version20220319122655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos_actions_masters CHANGE altphotoactionsmaster altphotoactionsmaster VARCHAR(255) DEFAULT NULL');
    }
