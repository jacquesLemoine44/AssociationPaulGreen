 ...
 */
final class Version20220322161236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE news CHANGE shorttextnew shorttextnew LONGTEXT DEFAULT NULL');
    }
