 ...
 */
final class Version20220323145930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actions_assos ADD shorttextactionsasso LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE actions_masters ADD shorttextactionsmaster LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE fieldtrips ADD shorttextfieldtrip LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE internships ADD shorttextinternship LONGTEXT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE photoactionsmaster (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE actions_assos DROP shorttextactionsasso, CHANGE titleactionsasso titleactionsasso VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE pictureactionsasso pictureactionsasso VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE textactionsasso textactionsasso LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE linkactionsasso linkactionsasso VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE titlelinkactionsasso titlelinkactionsasso VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE alt_picture_actions_assos alt_picture_actions_assos VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE actions_masters DROP shorttextactionsmaster, CHANGE titleactionsmaster titleactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE pictureactionsmaster pictureactionsmaster VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE altpictureactionsmaster altpictureactionsmaster VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE textactionsmaster textactionsmaster LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE titlelinkactionsmaster titlelinkactionsmaster VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE linkactionsmaster linkactionsmaster VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE doc_actions_masters CHANGE titledocactionsmaster titledocactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE linkdocactionsmaster linkdocactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE link_actions_masters CHANGE titlelinkactionsmaster titlelinkactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE linkactionmaster linkactionmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE news CHANGE title_new title_new VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE picture_new picture_new VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE text_new text_new LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE altpicturenew altpicturenew VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE shorttextnew shorttextnew LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE photos_actions_masters CHANGE photoactionsmaster photoactionsmaster VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE altphotoactionsmaster altphotoactionsmaster VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
