...
{
    /**
     * @Route("/", name="functions_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="functions_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('functions_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('functions/new.html.twig', [
            'function' => $function,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="functions_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="functions_edit", methods={"GET", "POST"})
     */
    public function edit(Request $request, Functions $function, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('functions/edit.html.twig', [
            'function' => $function,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="functions_delete", methods={"POST"})
     */
