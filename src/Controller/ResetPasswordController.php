...
class ResetPasswordController extends AbstractController
{
     ...
     */
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, TranslatorInterface $translator, string $token = null,
    ParamsRepository $paramsRepository, 
    SocialNetworksRepository $socialNetworksRepository
    ): Response
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('no-reply@gmail.com', 'PaulGreen'))
            ->to($user->getEmail())
